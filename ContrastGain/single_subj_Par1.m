...
%cd('/home/abhilash/Documents/MATLAB/Contrast Gain/Processed Data/Paradigm3');
cd('C:\MATLAB\Abhi\Psychophysics\For Ninni\Contrast Gain\Processed Data\Paradigm1');

%dirName.P1 = '/home/abhilash/Documents/MATLAB/Contrast Gain/Processed Data/Paradigm3';
dirName.P1 = 'C:\MATLAB\Abhi\Psychophysics\For Ninni\Contrast Gain\Processed Data\Paradigm1';
...
for i = 1:s
    ...
    legend('Sound','No Sound','Location','SouthEast')
...
for i = 1:s
    ...
    hold on
    plot([0 5],[0 5], '-k')
    title('Slopes per subject, Sound vs No Sound','FontSize',15)
    axis([0 5 0 5])
    xlabel('Slopes - Sound','FontSize',15)
    ylabel('Slopes - No Sound','FontSize',15)
    grid on
...
for i = 1:s
    ...
    hold on
    plot([10 26],[10 26], '-k')
    title('Thresholds at 50% per subject, Sound vs No Sound','FontSize',15)
    axis([10 26 10 26])
    xlabel('Gain order - Sound','FontSize',15)
    ylabel('Gain order - No Sound','FontSize',15)
    grid on
