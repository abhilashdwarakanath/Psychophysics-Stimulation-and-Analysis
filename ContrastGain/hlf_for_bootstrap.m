function param_ests = hlf_for_bootstrap(data,Params)

% function results = hrflsefit(data,Params) takes in parameters for the model
% and the data from the Contrast Gain experiment, fits the model to the
% data and returns the parameters "Gain", "C50" and "N"
%
% It uses the a neighbourhood search routine to minimise the error function
